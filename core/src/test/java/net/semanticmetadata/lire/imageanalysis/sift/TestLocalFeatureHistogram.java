...
public class TestLocalFeatureHistogram extends TestCase {
    ...
    private String indexPath = "target/testout/wang-index";
    private String testExtensive = "src/test/resources/flickrphotos";
...
//        }
    ...
    public void testSiftIndexing() throws IOException {
        ...
        IndexWriter iw = LuceneUtils.createIndexWriter("target/testout/sift-idx", true);
...
//            String s = testExtensive + "/" + sampleQuery + ".jpg";
    ...
    public void testSurfIndexing() throws IOException {
        ...
        IndexWriter iw = LuceneUtils.createIndexWriter("target/testout/surf-idx", true);
        for (int i = 0; i < images.size(); i++) {
//            int sampleQuery = sampleQueries[i];
//            String s = testExtensive + "/" + sampleQuery + ".jpg";
            iw.addDocument(DocumentBuilderUtils.createDocument(db, images.get(i), images.get(i)));
    ...
    public void testCreateLocalFeatureHistogram() throws IOException {
        ...
        SiftFeatureHistogramBuilder sh = new SiftFeatureHistogramBuilder(DirectoryReader.open(FSDirectory.open(new File("target/testout/sift-idx"))), 2000);
        sh.index();
        testFindimages();
    }
    ...
    public void testCreateSurfFeatureHistogram() throws IOException {
        ...
        SurfFeatureHistogramBuilder sh = new SurfFeatureHistogramBuilder(DirectoryReader.open(FSDirectory.open(new File("target/testout/surf-idx"))), 500, 1000);
        sh.index();
//        testFindimages();
    }
